...
/**
 * KL_PasswordTools_Zxcvbn_Matchers_Match
 *
 *	@author: Ben Jeavons
 *  @last_edit:	15.08.2015
 */

abstract class KL_PasswordTools_Zxcvbn_Matchers_Match implements KL_PasswordTools_Zxcvbn_Matchers_MatchInterface
{
